...
cv2.createTrackbar("Lower Hue", "Color detectors", 20, 180,set_values)
cv2.createTrackbar("Lower Saturation", "Color detectors", 255, 255,set_values)
cv2.createTrackbar("Lower Value", "Color detectors", 45, 255,set_values)
